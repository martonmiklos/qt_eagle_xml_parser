...
class Element
{
  ...
  public:
    ...
    Variant::List variantList() const;
...
class Designrules
{
  public:
    ...
    Description::List descriptionList() const;
    void addParam( const Param &v );
    void setParamList( const Param::List &v );
    Param::List paramList() const;
    /**
...
class Frame
{
  ...
  public:
    enum Border-leftEnum { Border-left_no, Border-left_yes, Border-left_Invalid };
    enum Border-topEnum { Border-top_no, Border-top_yes, Border-top_Invalid };
    enum Border-rightEnum { Border-right_no, Border-right_yes, Border-right_Invalid };
    enum Border-bottomEnum { Border-bottom_no, Border-bottom_yes, Border-bottom_Invalid };
  ...
  public:
    ...
    void setLayer( int v );
    int layer() const;
    void setBorder-left( const Border-leftEnum &v );
    Frame::Border-leftEnum border-left() const;
    void setBorder-top( const Border-topEnum &v );
    Frame::Border-topEnum border-top() const;
    void setBorder-right( const Border-rightEnum &v );
    Frame::Border-rightEnum border-right() const;
    void setBorder-bottom( const Border-bottomEnum &v );
    Frame::Border-bottomEnum border-bottom() const;
    static QString border-leftEnumToString( const Border-leftEnum & v );
    static QString border-topEnumToString( const Border-topEnum & v );
    static QString border-rightEnumToString( const Border-rightEnum & v );
    static QString border-bottomEnumToString( const Border-bottomEnum & v );
    /**
      Parse XML object from DOM element.
     */
  ...
  private:
    static Frame::Border-leftEnum border-leftEnumFromString( const QString & v, bool *ok = NULL );
    static Frame::Border-topEnum border-topEnumFromString( const QString & v, bool *ok = NULL );
    static Frame::Border-rightEnum border-rightEnumFromString( const QString & v, bool *ok = NULL );
    static Frame::Border-bottomEnum border-bottomEnumFromString( const QString & v, bool *ok = NULL );
    ...
    int mRows;
    int mLayer;
    Border-leftEnum mBorder-left;
    Border-topEnum mBorder-top;
    Border-rightEnum mBorder-right;
    Border-bottomEnum mBorder-bottom;
};
...
class Package3dinstances
{
  public:
    ...
    Package3dinstance::List package3dinstanceList() const;
    /**
      Parse XML object from DOM element.
     */
...
class Device
{
  ...
  public:
    ...
    Package3dinstances package3dinstances() const;
